...
// GA4/Google uses '_ga' cookie to track sessions and users.
// We set a unique dummy cookie that simulates a new GA Client ID for every request.
$ga_cookie_value = "GS1.1." . $unique_id . "." . time(); 

$headers = array(
    // Real-world User-Agent is critical
    "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36",
    // CRITICAL: Send the unique cookie
    "Cookie: _ga=" . $ga_cookie_value . ";",
    // Accept standard content types
